# -*- coding: utf-8 -*-
"""
Script to sort CLC workbech output BRCAness, to extract the panel specific 
exons with coverage below 100 and to add current inernal 
variantlist (variantDBi)

Input: xlsx-file from CLC workbench BRCAness workflow, exontableBRCAness.xlxs 
and variantDBi.xlsx
Current variantDBi is hardcoded, newer versions of the variantDBi has to be 
updated in this script (line: 143)
Output: xlsx file (sorted BRCAness variantlist with added variantDBi and exon 
...
# Script used
print("Script: processing_BRCAness.py")
...
# Getting exon table BRCAness
exon_table_filename = "exontableBRCAness.xlsx"
